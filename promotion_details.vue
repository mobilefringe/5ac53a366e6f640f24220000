			...
			<div class="row">
				...
				<div class="col-sm-12 promo_image_container text-left">
					...
					<div class="row">
					    ...
					    <p class="event_store_name caps pull-left" v-if="locale=='en-ca'">{{currentPromo.store.name}}</p>
	        		    <p class="event_store_name caps pull-left" v-else>{{currentPromo.store.name_2}}</p>
