<template>
    <div id="contact_us_container"> <!-- for some reason if you do not put an outer container div this component template will not render -->
        ...
        <div style="height: 300px;margin-bottom:-30px;" class="show_phone">
    	    <iframe class="grayscale" title="Map" width="100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  src="https://maps.google.nl/maps?q=216 Chrislea RoadVaughanCanadaONON&hl=en&ie=UTF8&t=v&hnear=216 Chrislea RoadVaughanCanadaONON&z=16&output=embed">
    			Map
    		</iframe>
		</div>
    </div>
